...
export function App() {
  ...
  const [currentView, setCurrentView] = useState<'DASHBOARD' | 'STRATEGY_HUB' | 'IRON_CONDOR' | 'IRON_BUTTERFLY' | 'BULL_PUT_CREDIT'>('DASHBOARD');

  const handleSelectView = (view: 'DASHBOARD' | 'STRATEGY_HUB' | 'IRON_CONDOR' | 'IRON_BUTTERFLY' | 'BULL_PUT_CREDIT', sectionId?: string) => {
    setCurrentView(view);
